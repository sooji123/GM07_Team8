...
public class BossEnemy : EnemyBase
{
    ...
    void Update()
    {
        ...
        if (spriteRenderers != null)
        {
            ...
            {
                if (sr != null) sr.flipX = (goalTransform.position.x > transform.position.x);
            }
        }
            ...
            if (waveManager != null)
            {
                ...
                foreach (EnemyBase enemy in allEnemies)
                {
                    if (enemy != null && enemy != this && enemy.gameObject.activeSelf)
                    {
                        ...
                        if (enemy.childRegenObject != null)
                        {
                            enemy.childRegenObject.SetActive(true);
                            StartCoroutine(DisableRegenVisual(enemy.childRegenObject));
                        }
                    }
                }
            }
    ...
    private IEnumerator DisableRegenVisual(GameObject regenVisual)
    {
